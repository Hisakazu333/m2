...
and does not represent the unavailable repository as audited. No participant
data or private deployment logs are used.

\paragraph{Computational assistance.}
Portions of the mathematical development, drafting, and programming used AI
assistance; all results were checked by the author. This work claims neither
formal proof verification, nor peer-review acceptance, nor confirmed priority
over all related literature.
