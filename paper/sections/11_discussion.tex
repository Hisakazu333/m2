...
sources, bibliography, the exact rational Bayes solver, an independent
policy-tree enumerator, two decoder implementations, frozen configurations,
numerical outputs, and figure-generation commands. Complete code,
configurations, and tests are available as anonymized supplementary material.
The provided source archive for the earlier manuscript contained LaTeX and
generated outputs; its original Python repository was not supplied. The
present release uses the independently reconstructed evaluators described here
and does not represent the unavailable repository as audited. Portions of the
mathematical development, drafting, and programming used AI assistance; all
results were checked by the author. This work claims neither formal proof
verification, nor peer-review acceptance, nor confirmed priority over all
related literature. No participant data or private deployment logs are used.
