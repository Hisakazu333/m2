...
intervene under a finite task deadline? The two questions share the
intervention viewpoint and, in our formalization, one joint observation--state
convention with the same physical kernels; their objective functions differ,
so we study them as two separate contracts rather than as one interchangeable
...
observation--state convention and explicit loss accounting.
Figure~\ref{fig:contracts} summarizes the two contracts. All declared
